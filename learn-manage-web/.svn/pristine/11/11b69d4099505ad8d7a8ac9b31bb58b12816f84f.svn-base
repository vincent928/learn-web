        ...
        <div class="col-md-9 col-md-offset-3" style="margin: 50px 10px 0px;">
        	<div id="rightTable">
        		...
        		<h3><span class="glyphicon glyphicon-align-justify" style="color:#3b7e3b;"/><font style="color:green;">我的作业</font></h3>
        		 ...
        		 <form id="newQuestion" action="/student/saveQuestion" method="post" style="height: 600px;overflow-y: auto;overflow-x:hidden; " >
        		 ...
        		 <div class="form-body">
					<table id="questionList" class="form-inline">
						...
						<tr>
							...
							<td>
								<label>答案：</label>
									<select id="judg${ju.index }" name="judg${ju.index }" class="form-control">
										<option>请选择</option>
										<option value="A">A</option>
										<option value="B">B</option>
									</select>
						...
						<!-- 主观题 -->
						<c:forEach items="${subjectList }" var="sub" varStatus="su">
						<tr>
							<td>
						...
						<tr>
							<td>
								<label></label><textarea id="subj${su.index}" name="subj${su.index }" class="form-control" rows="5" cols="60"></textarea>
							</td>
						</tr>
						<tr><td><br></td></tr>
						</c:forEach>
