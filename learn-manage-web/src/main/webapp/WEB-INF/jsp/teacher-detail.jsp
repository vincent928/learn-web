  ...
  <nav class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation" style="padding-left:50px">
      ...
      <div class="row">
        ...
        <div class="col-md-9 col-md-offset-3" style="margin: 50px 10px 0px;">
        	<div id="rightTable">
        		<div class="form-group">
        		<input onclick="back()" type="button" class="btn btn-primary" style="float: right;" value="返回"/>
        		<h3><span class="glyphicon glyphicon-align-justify" style="color:#3b7e3b;"/><font style="color:green;">作业详情</font></h3>
        		</div>
        		 ...
        		 <div class="form-inline" style="margin-top: 20px;">
        		 	<div class="row">
        		 		<div class="form-group col-md-4 col-md-offset-3" style="margin-bottom: 40px;">
			      			<label>题库标题:</label>
			      			<input type="text" class="form-control" id="title" name="title" placeholder="题库标题" readonly="readonly" value="${Qtitle }">
			      		</div>
			      		<div>
			      			<label>分数：</label>
			      			<input type="text" class="form-control" value="${scope }" placeholder="分数" readonly="readonly">
			      		</div>
        		 	</div>
        		 </div>
        		 <div class="form-body">
